export default {
  ...
  metrics: {
    heading: "مؤشرات الأداء المستهدفة والتقنيات المستخدمة",
    subheading: "البيئة الهندسية للمشروع ومقاييس جودة الأداء البرمجي المعتمدة",
    items: {
      accuracy: { title: "دقة الترتيب الذكي" },
      reduction: { title: "تقليص تكرار الصرف" },
      users: { title: "المستخدمين بالتوازي" },
    },
